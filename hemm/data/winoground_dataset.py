...
class WinogroundPTDataset(torch.utils.data.Dataset):
    def __init__(self,
                 dataset,
                 image_processor,
                 text_processor,
...
class WinogroundDatasetEvaluator(HEMMDatasetEvaluator, EvaluatorMixin):
    def __init__(self,
                 dataset_dir,
                 model,
                 text_processor,
    ...
    def evaluate_dataset(self,
        ...
        pt_dataset = WinogroundPTDataset(dataset, self.image_processor, self.text_processor, self.prompt, self.device)
