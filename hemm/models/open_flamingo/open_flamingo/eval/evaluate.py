...
from hemm.models.open_flamingo.open_flamingo.eval.eval_datasets import (
    CaptionDataset,
    VQADataset,
    ImageNetDataset,
    HatefulMemesDataset,
)
from hemm.models.open_flamingo.open_flamingo.eval.rices import RICES
...
from hemm.models.open_flamingo.open_flamingo.src.flamingo import Flamingo
from vqa_metric import compute_vqa_accuracy, postprocess_vqa_generation

from hemm.models.open_flamingo.open_flamingo.train.distributed import init_distributed_device, world_info_from_env
...
def evaluate_vqa(
    ...
    if test_annotations_json_path is not None:
        ...
        if dataset_name == "vqav2":
            from hemm.models.open_flamingo.open_flamingo.scripts.fill_vqa_testdev_results import (
